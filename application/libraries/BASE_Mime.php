 ...
 * @author _BA5E
 * @category library
 * @package application\libraries\BASE_Mime
 * @subpackage mimeType
 * 
 * @version 1.2
 * @since 1.2
 *  mime types are from codeigniters "mime.php" which has been merged with the mime types from "apache.org"
 * 	@see http://svn.apache.org/repos/asf/httpd/httpd/trunk/docs/conf/mime.types
 */
class BASE_Mime
{
	/**
	 * mimetypes for file extensions
	 * @var array
	 */
	...
	(
	   ...
	   'ai' => array("application/pdf","application/postscript","application/postscript"),
	   'aif' => array("audio/x-aiff","audio/aiff","audio/x-aiff"),
	   'aifc' => array("audio/x-aiff","audio/x-aiff"),
	   'aiff' => array("audio/x-aiff","audio/aiff","audio/x-aiff"),
	   ...
	   'au' => array("audio/x-au","audio/basic"),
	   'avi' => array("video/x-msvideo","video/msvideo","video/avi","application/x-troff-msvideo","video/x-msvideo"),
	   ...
	   'bin' => array("application/macbinary","application/mac-binary","application/octet-stream","application/x-binary","application/x-macbinary","application/octet-stream"),
	   'blb' => array("application/x-blorb"),
	   'blorb' => array("application/x-blorb"),
	   'bmi' => array("application/vnd.bmi"),
	   'bmp' => array("image/bmp","image/x-bmp","image/x-bitmap","image/x-xbitmap","image/x-win-bitmap","image/x-windows-bmp","image/ms-bmp","image/x-ms-bmp","application/bmp","application/x-bmp","application/x-win-bitmap","image/bmp"),
	   ...
	   'cer' => array("application/pkix-cert","application/x-x509-ca-cert","application/pkix-cert"),
	   ...
	   'class' => array("application/octet-stream","application/java-vm"),
	   ...
	   'cpp' => array("text/x-c"),
	   'cpt' => array("application/mac-compactpro","application/mac-compactpro"),
	   'crd' => array("application/x-mscardfile"),
	   'crl' => array("application/pkix-crl","application/pkcs-crl","application/pkix-crl"),
	   'crt' => array("application/x-x509-ca-cert","application/x-x509-user-cert","application/pkix-cert","application/x-x509-ca-cert"),
	   ...
	   'css' => array("text/css","text/plain","text/css"),
	   'cst' => array("application/x-director"),
	   'csv' => array("text/x-comma-separated-values","text/comma-separated-values","application/octet-stream","application/vnd.ms-excel","application/x-csv","text/x-csv","text/csv","application/csv","application/excel","application/vnd.msexcel","text/plain","text/csv"),
	   ...
	   'dcr' => array("application/x-director","application/x-director"),
	   ...
	   'der' => array("application/x-x509-ca-cert","application/x-x509-ca-cert"),
	   'dfac' => array("application/vnd.dreamfactory"),
	   'dgc' => array("application/x-dgc-compressed"),
	   'dic' => array("text/x-c"),
	   'dir' => array("application/x-director","application/x-director"),
	   ...
	   'dll' => array("application/octet-stream","application/x-msdownload"),
	   'dmg' => array("application/x-apple-diskimage"),
	   'dmp' => array("application/vnd.tcpdump.pcap"),
	   'dms' => array("application/octet-stream","application/octet-stream"),
	   'dna' => array("application/vnd.dna"),
	   'doc' => array("application/msword","application/vnd.ms-office","application/msword"),
	   'docm' => array("application/vnd.ms-word.document.macroenabled.12"),
	   'docx' => array("application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/zip","application/msword","application/x-zip","application/vnd.openxmlformats-officedocument.wordprocessingml.document"),
	   'dot' => array("application/msword","application/vnd.ms-office","application/msword"),
	   'dotm' => array("application/vnd.ms-word.template.macroenabled.12"),
	   'dotx' => array("application/vnd.openxmlformats-officedocument.wordprocessingml.document","application/zip","application/msword","application/vnd.openxmlformats-officedocument.wordprocessingml.template"),
	   ...
	   'eml' => array("message/rfc822","message/rfc822"),
	   ...
	   'eps' => array("application/postscript","application/postscript"),
	   ...
	   'exe' => array("application/octet-stream","application/x-msdownload","application/x-msdownload"),
	   ...
	   'flac' => array("audio/x-flac","audio/x-flac"),
	   ...
	   'gtar' => array("application/x-gtar","application/x-gtar"),
	   ...
	   'hqx' => array("application/mac-binhex40","application/mac-binhex","application/x-binhex40","application/x-mac-binhex40","application/mac-binhex40"),
	   'htke' => array("application/vnd.kenameaapp"),
	   'htm' => array("text/html","text/plain","text/html"),
	   'html' => array("text/html","text/plain","text/html"),
	   ...
	   'ics' => array("text/calendar","text/calendar"),
	   'ief' => array("image/ief"),
	   ...
	   'jar' => array("application/java-archive","application/x-java-application","application/x-jar","application/x-compressed","application/java-archive"),
	   ...
	   'jpe' => array("image/jpeg","image/pjpeg","image/jpeg"),
	   ...
	   'jpm' => array("video/jpm"),
	   'js' => array("application/x-javascript","text/plain","application/javascript"),
	   ...
	   'kml' => array("application/vnd.google-earth.kml+xml","application/xml","text/xml","application/vnd.google-earth.kml+xml"),
	   'kmz' => array("application/vnd.google-earth.kmz","application/zip","application/x-zip","application/vnd.google-earth.kmz"),
	   ...
	   'lha' => array("application/octet-stream","application/x-lzh-compressed"),
	   ...
	   'log' => array("text/plain","text/x-log","text/plain"),
	   ...
	   'lzh' => array("application/octet-stream","application/x-lzh-compressed"),
	   ...
	   'm3u' => array("text/plain","audio/x-mpegurl"),
	   'm3u8' => array("application/vnd.apple.mpegurl"),
	   'm4a' => array("audio/x-m4a","audio/mp4"),
	   'm4u' => array("application/vnd.mpegurl","video/vnd.mpegurl"),
	   ...
	   'mid' => array("audio/midi","audio/midi"),
	   'midi' => array("audio/midi","audio/midi"),
	   'mie' => array("application/x-mie"),
	   'mif' => array("application/vnd.mif","application/vnd.mif"),
	   ...
	   'mov' => array("video/quicktime","video/quicktime"),
	   'movie' => array("video/x-sgi-movie","video/x-sgi-movie"),
	   'mp2' => array("audio/mpeg","audio/mpeg"),
	   'mp21' => array("application/mp21"),
	   'mp2a' => array("audio/mpeg"),
	   'mp3' => array("audio/mpeg","audio/mpg","audio/mpeg3","audio/mp3","audio/mpeg"),
	   'mp4' => array("video/mp4","video/mp4"),
	   'mp4a' => array("audio/mp4"),
	   'mp4s' => array("application/mp4"),
	   'mp4v' => array("video/mp4"),
	   'mpc' => array("application/vnd.mophun.certificate"),
	   'mpe' => array("video/mpeg","video/mpeg"),
	   'mpeg' => array("video/mpeg","video/mpeg"),
	   'mpg' => array("video/mpeg","video/mpeg"),
	   'mpg4' => array("video/mp4"),
	   'mpga' => array("audio/mpeg","audio/mpeg"),
	   ...
	   'oda' => array("application/oda","application/oda"),
	   ...
	   'otf' => array("application/x-font-otf"),
	   ...
	   'p10' => array("application/x-pkcs10","application/pkcs10","application/pkcs10"),
	   'p12' => array("application/x-pkcs12","application/x-pkcs12"),
	   'p7a' => array("application/x-pkcs7-signature"),
	   'p7b' => array("application/x-pkcs7-certificates"),
	   'p7c' => array("application/pkcs7-mime","application/x-pkcs7-mime","application/pkcs7-mime"),
	   'p7m' => array("application/pkcs7-mime","application/x-pkcs7-mime","application/pkcs7-mime"),
	   'p7r' => array("application/x-pkcs7-certreqresp","application/x-pkcs7-certreqresp"),
	   'p7s' => array("application/pkcs7-signature","application/pkcs7-signature"),
	   ...
	   'pdf' => array("application/pdf","application/force-download","application/x-download","binary/octet-stream","application/pdf"),
	   ...
	   'pgp' => array("application/pgp","application/pgp-encrypted"),
	   ...
	   'png' => array("image/png","image/x-png","image/png"),
	   ...
	   'ppt' => array("application/powerpoint","application/vnd.ms-powerpoint","application/vnd.ms-office","application/msword","application/vnd.ms-powerpoint"),
	   'pptm' => array("application/vnd.ms-powerpoint.presentation.macroenabled.12"),
	   'pptx' => array("application/vnd.openxmlformats-officedocument.presentationml.presentation","application/x-zip","application/zip","application/vnd.openxmlformats-officedocument.presentationml.presentation"),
	   ...
	   'ps' => array("application/postscript","application/postscript"),
	   'psb' => array("application/vnd.3gpp.pic-bw-small"),
	   'psd' => array("application/x-photoshop","image/vnd.adobe.photoshop","image/vnd.adobe.photoshop"),
	   ...
	   'qt' => array("video/quicktime","video/quicktime"),
	   ...
	   'ram' => array("audio/x-pn-realaudio","audio/x-pn-realaudio"),
	   'rar' => array("application/x-rar","application/rar","application/x-rar-compressed","application/x-rar-compressed"),
	   ...
	   'rtx' => array("text/richtext","text/richtext"),
	   ...
	   'sit' => array("application/x-stuffit","application/x-stuffit"),
	   ...
	   'so' => array("application/octet-stream","application/octet-stream"),
	   ...
	   'spx' => array("audio/ogg"),
	   'sql' => array("application/x-sql", "text/plain"),
	   ...
	   'svg' => array("image/svg+xml","application/xml","text/xml","image/svg+xml"),
	   'svgz' => array("image/svg+xml"),
	   'swa' => array("application/x-director"),
	   'swf' => array("application/x-shockwave-flash","application/x-shockwave-flash"),
	   ...
	   'tar' => array("application/x-tar","application/x-tar"),
	   ...
	   'tif' => array("image/tiff","image/tiff"),
	   'tiff' => array("image/tiff","image/tiff"),
	   ...
	   'vcf' => array("text/x-vcard","text/x-vcard"),
	   ...
	   'wav' => array("audio/x-wav","audio/wave","audio/wav","audio/x-wav"),
	   ...
	   'webm' => array("video/webm","video/webm"),
	   ...
	   'wma' => array("audio/x-ms-wma","video/x-ms-asf","audio/x-ms-wma"),
	   ...
	   'wmv' => array("video/x-ms-wmv","video/x-ms-asf","video/x-ms-wmv"),
	   ...
	   'xht' => array("application/xhtml+xml","application/xhtml+xml"),
	   'xhtml' => array("application/xhtml+xml","application/xhtml+xml"),
	   ...
	   'xls' => array("application/vnd.ms-excel","application/msexcel","application/x-msexcel","application/x-ms-excel","application/x-excel","application/x-dos_ms_excel","application/xls","application/x-xls","application/excel","application/download","application/vnd.ms-office","application/msword","application/vnd.ms-excel"),
	   ...
	   'xm' => array("audio/xm"),
	   'xml' => array("application/xml","text/xml","text/plain","application/xml"),
	   ...
	   'xsl' => array("application/xml","text/xsl","text/xml","application/xml"),
	   'xslt' => array("application/xslt+xml"),
	   'xsm' => array("application/vnd.syncml+xml"),
	   'xspf' => array("application/xspf+xml","application/xspf+xml"),
	   ...
	   'zip' => array("application/x-zip","application/zip","application/x-zip-compressed","application/s-compressed","multipart/x-zip","application/zip"),
	...
	static function getImageTypes(){
		$types = array_unique(
			array_merge(
				BASE_Mime::getMimetypeByExtension("jpg"),
				BASE_Mime::getMimetypeByExtension("png"),
				BASE_Mime::getMimetypeByExtension("gif"),
				BASE_Mime::getMimetypeByExtension("svg")
			), SORT_REGULAR
		);
	...
	/**
	 * returns an array containing the corresponding mimetypes
	 * 
	 * @param string $ext	>> file extension
	 * 
	 * @return array 		>> array with valid mimetypes or null
	 */
	 ...
	 * @param string $file
	 */
	static function getMimetypesForFileExtension($file){
	
		$ext = self::getExtensionForFile($file);
	 ...
	 * @return string $ext
	 */
	static function getExtensionForFile($file){
	 ...
	 * !! quick & dirty  !!
	 * 
	 * detect if the mime type of $file is matching the expected type for the extension of $file
	 * 
	 * if the file has the extension ".jpg" for example, it must match one of the folloing mimetypes (@see ::getMimetypeByExtension() ):
	 * - "image/jpeg"
	 * - "image/pjpeg"
	 * - "image/jpeg"
	 * 
	 ...
	 * @return bool
	 */
	static function validate_mimetype($file)
	{
		$file_mimetype 		= @finfo_file(@finfo_open(FILEINFO_MIME_TYPE), $file);
		$file_ext			= strtolower( @end( @explode('.', $file) ));
    	$allowedMimtypes 	= self::getMimetypeByExtension($file_ext);
    	
    	if($allowedMimtypes && !in_array(strtolower($file_mimetype), $allowedMimtypes))
    	{
    		//$these 		= implode(', ', $allowedMimtypes);
    		//$message 	= lang("error").": ".sprintf(lang("for_the_extension_x_only_the_following_filetypes_are_allowed_x"), $Extension, $these);
    		return false;
    	}
    	//$message = lang("message").": ".lang("file_type_is_valid");
    	return true;
	}
}
?>